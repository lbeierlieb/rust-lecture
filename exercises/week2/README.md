...
In a 100x100 world where 3000 of the 10000 cells are inhabited, the population density is 30%.
...
The code is restricted to use only Rust language features taught in the first twelve hours of the lecture.
